...
import { ChevronLeft, Save, Image as ImageIcon, Sparkles } from "lucide-react";
    ...
    <AdminLayout>
      <div className="max-w-4xl">
        <header className="mb-10">
          ...
          <h1 className="font-display text-3xl font-bold text-gray-900">Create New Course</h1>
          <p className="text-gray-500 mt-1">Fill in the details to launch your next masterpiece.</p>
        </header>
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Advanced Bridal Makeup Masterclass"
                />
              </div>
